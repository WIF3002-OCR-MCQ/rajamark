...
Future<void> updateExamById(
    String examId, Map<String, dynamic> updatedExamData) async {
  CollectionReference exams = FirebaseFirestore.instance.collection('exam');
...
Future<List<Map<String, dynamic>>> getAllExams() async {
  ...
  try {
    ...
    List<Map<String, dynamic>> examList = querySnapshot.docs
...
Future<List<Map<String, dynamic>>> getStudentResultByStudentId(
    String studentId) async {
  try {
    CollectionReference resultsCollection =
        FirebaseFirestore.instance.collection('student_result');
    QuerySnapshot querySnapshot =
        await resultsCollection.where('student_id', isEqualTo: studentId).get();
    List<Map<String, dynamic>> resultsList = querySnapshot.docs
        .map((doc) => doc.data() as Map<String, dynamic>)
        .toList();
    return resultsList;
  } catch (e) {
...
Future<List<Map<String, dynamic>>> getStudentResultByExamId(
    String examId) async {
  try {
    CollectionReference resultsCollection =
        FirebaseFirestore.instance.collection('student_result');
...
Future<List<Map<String, dynamic>>> getStudentResultByStudentIdAndExamId(
...
Future<void> updateStudentResultByExamIdAndStudentId(String examId,
...
Future<void> deleteStudentResultByExamIdAndStudentId(
...
Future<List<Map<String, dynamic>>> getGradeByExamIdAndGradeLabel(
...
Future<void> updateGradeByExamIdAndGradeLabel(String examId, String gradeLabel,
    Map<String, dynamic> updatedGradeData) async {
  CollectionReference grade = FirebaseFirestore.instance.collection('grade');
  try {
    // Query to retrieve the specific document where both studentId and examId match
    QuerySnapshot querySnapshot = await grade
